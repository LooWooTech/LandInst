...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vcheck_member` AS select `checklog`.`ID` AS `ID`,`checklog`.`InfoID` AS `InfoID`,`checklog`.`UserID` AS `UserID`,`checklog`.`CheckType` AS `CheckType`,`checklog`.`UpdateTime` AS `UpdateTime`,`checklog`.`Result` AS `Result`,`checklog`.`CreateTime` AS `CreateTime`,`member`.`RealName` AS `RealName`,`member`.`Status` AS `Status`,`member`.`Gender` AS `Gender`,`member`.`InstitutionID` AS `InstitutionID`,`member`.`Major` AS `Major`,`member`.`EduRecord` AS `EduRecord`,`checklog`.`Data` AS `Data` from (`checklog` join `member` on((`checklog`.`UserID` = `member`.`ID`)));
...
INSERT INTO `member` VALUES ('1', '26', '郑良俊', '32032219821027003X', '1982-10-27 00:00:00', '男', '1', '2', '2', null, null);
...
INSERT INTO `profile` VALUES ('2', '1', '2014-08-18 16:20:03', null, , null);
INSERT INTO `user` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '你喜欢的宠物叫什么名字？', null, '2014-07-22 20:43:58', '2014-08-19 11:24:16', '::1', '4', '3', '');
INSERT INTO `user` VALUES ('26', '杭州智拓房地产土地评估咨询有限公司', 'e10adc3949ba59abbe56e057f20f883e', null, null, '2014-08-18 14:34:39', '2014-08-19 15:25:31', '::1', '6', '2', '');
